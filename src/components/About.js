...
import imgPostman from "../images/technologies/postman.png";
  ...
  return (
    <div id="about" className="about">
      ...
      <div className="about-description">
        <p>
          I’m a Full Stack Developer with a passion for solving problems and
          turn ideas into reality. Well-organized person, resourceful,
          independent employee with a high attention to detail and dedication to
          drive innovation. Fan of paddle boarding, hiking and binging TV shows.
